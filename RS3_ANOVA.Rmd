...
The above producessums of squares, mean square and eta squared values that are the same. However the f value is different?
...
- Compute interaction plots for ANOVA
- Compute estimated margin means for main effects
- Compute paired samples t test for investigating interaction
